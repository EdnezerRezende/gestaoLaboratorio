...
public class FornecedorController {
    ...
    @RequestMapping(value = "excluirFornecedor/{id}", method = DELETE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public String excluirProduto(@PathVariable(value = "id") Long idFornecedor){
        return fornecedorService.excluirFornecedor(idFornecedor);
    }
}

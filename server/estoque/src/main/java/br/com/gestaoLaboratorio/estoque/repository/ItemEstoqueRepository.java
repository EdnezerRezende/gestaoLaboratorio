...
//    List<ItemEstoque> totalEstoque();
    ...
    @Async
    @Query(value = "Select new br.com.gestaoLaboratorio.estoque.persistence.entity.DTO.EstoqueDTO( produto.codigoProduto, produto.nome, count(estoque.produto)) from Produto produto left join ItemEstoque estoque on estoque.produto = produto group by produto.codigoProduto, produto.nome order by produto.nome")
